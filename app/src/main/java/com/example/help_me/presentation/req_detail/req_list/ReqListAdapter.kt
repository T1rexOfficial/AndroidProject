...
class CompanyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    fun bindView(company: Company) {
        ...
        Log.d("ReqListAdapter", company.photoURL.orEmpty())
        itemView.photoCompanyImageView.loadImage(
            company.photoURL.orEmpty(),
            itemView.context ?: return,
            R.drawable.company_noavatar
        )
    }
}
...
class UserViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    fun bindView(user: User) {
        ...
        itemView.photoAccountImageView.loadImage(
